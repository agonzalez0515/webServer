...
public class Router {
    ...
    private Map<String, Callback<Request, String>> DELETERoutes = new HashMap<>();
    ...
    public void delete(String route, Callback<Request, String> controller) {
        DELETERoutes.put(route, controller);
    }
